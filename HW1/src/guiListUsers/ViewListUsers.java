...
public class ViewListUsers {
    ...
    private static void setupTable() {
        ...
        TableColumn<UserRow, Boolean> cStaff = new TableColumn<>("Staff");
        cStaff.setPrefWidth(80);
        cStaff.setCellValueFactory(cd -> new SimpleBooleanProperty(cd.getValue().getStaff()));
        ...
        cStaff.prefWidthProperty().bind(usableWidth.multiply(0.06));

        table.getColumns().addAll(Arrays.asList(
        		cUsername, cFirst, cMiddle, cLast, cPref, cEmail, cAdmin, cStudent, cStaff
        		));
    }
    ...
    public static class UserRow {
        ...
        public UserRow(String username, String firstName, String middleName, String lastName,
                String preferredFirstName, String emailAddress, boolean adminRole, boolean studentRole, boolean staffRole) {
        ...
        public boolean getStaff() { return staffRole; }
    }
}
