...
public class ViewOneTimePassword {
	...
	*/
	...
	// Area 2a: This allows the admin to select a user of the system as the first step in giving
	// them a temp password.  The act of selecting a user causes the change is the GUI.  The 
	// Admin does not need to push a button to make this happen.
	...
	*/
	...
	public ViewOneTimePassword() {
		...
		// GUI Area 2b
		setupTextUI(text_Password, "Arial", 18, 300, Pos.BASELINE_LEFT, 50, 210, false);
